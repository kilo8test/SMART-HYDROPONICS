                ...
                Expanded(
                  child: GridView.count(
                    ...
                    children: [
                      ...
                      _AdminCard(
                        title: 'Add Plant',
                        subtitle: 'Add new plants to the system',
                        icon: Icons.add,
                        color: const Color(0xFFDC2626), // Red - matching admin theme
                        onTap: () {
                          showModalBottomSheet(
                            ...
                            builder: (BuildContext context) {
                              return const AdminAddPlantBottomSheet();
                            },
                          );
                        },
                      ),
  ...
  Future<void> _handleRequestAction(String requestId, String userId, String action) async {
    ...
    try {
      ...
      if (action == 'approve') {
        ...
        await AdminService.approveAdminRequest(requestId, adminId);
      } else {
        // Reject the admin request
        await AdminService.rejectAdminRequest(requestId, adminId);
      }
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                action == 'approve'
                    ? 'Enter your admin password to approve this request. The user will gain full administrative privileges.'
                    : 'Enter your admin password to reject this request. The user account will be permanently deleted.',
              ),
              const SizedBox(height: 16),
              TextField(
