      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Row(
            children: [
              Icon(
                turnOn ? Icons.water_drop : Icons.block,
                color: Colors.white,
              ),
              const SizedBox(width: 8),
              Text(
                turnOn 
                    ? 'Pump ACTIVATED - Water flowing!'
                    : 'Pump DEACTIVATED - Flow stopped',
              ...
              child: SizedBox.expand(
                child: Column(
                  ...
                  children: [
                    ...
                    // Quick Action Button - Water Level Only (shown when water level is selected)
                    if (_selectedMetric?.title == 'Water Level')
                    Padding(
                      ...
                      child: Center(
                        child: _QuickActionButton(
                          ...
                          color: _isPumpLoading 
                              ? Colors.grey 
                              : (_pumpStatus ? const Color(0xFF00B4D8) : Colors.grey[600]!),
                          onTap: () {
                            if (_isPumpLoading) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                ...
                                const SnackBar(
                                  content: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Text(
                                        'No water detected - Cannot activate pump',
                                        style: TextStyle(color: Colors.white),
                                      ),
                                    ],
                                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        style: GoogleFonts.inter(
                          color: metric.title == 'Water Level' 
                              ? (metric.value == 'DETECTED' ? const Color(0xFF16A34A) : const Color(0xFFEF4444))
                              : computedStatusColor,
                          fontSize: metric.title == 'Water Level' ? 22 : 26,  // Slightly smaller for water level
